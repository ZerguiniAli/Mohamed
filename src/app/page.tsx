...
export default function Home() {
  return (
   <div className="overflow-hidden">
    ...
    <Image src={news} alt="" layout="fill" objectFit="cover" className="bg-black opacity-70"/>
  ...
  <Image alt="" src={press} className="w-52 max-w-full"/>
  <Image alt="" src={logo} className="w-28 max-w-full"/>
  <Image alt="" src={APCDALS} className="w-28 max-w-full"/>
  <Image alt="" src={baosem} className="w-28 max-w-full"/>
  <Image alt="" src={bomop} className="w-28 max-w-full"/>
</div>
